...
// s
// const tempToggleCelsius = document.querySelector('.temperature-toggle-celsius');
// const tempToggleFahrenheit = document.querySelector('.temperature-toggle-fahrenheit');
...
ctaButton.addEventListener("click", () => {
  window.open("https://github.com/Marri-Rahul/Weather-DashBoard/tree/main");
});
